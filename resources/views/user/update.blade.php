    ...
    <x-body>
        ...
        <form action="{{ route('user.update', $user->id) }}" method="POST">
            ...
            <div class="flex flex-wrap flex-lg-columns justify-around">
                ...
                <x-form.input name="password" placeholder="exemple@mail.com" type="password" label="Password" value=""/>
                ...
                <x-form.input name="address" placeholder="Meril street 23" type="text" label="Address" value="{{ $user->address }}"/>
                <x-form.input name="city" placeholder="New York" type="text" label="City" value="{{ $user->city }}"/>
                <x-form.input name="country" placeholder="USA" type="text" label="Country" value="{{ $user->country }}"/>
