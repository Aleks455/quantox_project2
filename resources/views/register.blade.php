    ...
    <div class="flex justify-center">
        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <x-form.input_register name="first_name" placeholder="John" type="text" label="First Name"/>
                <x-form.input_register name="last_name" placeholder="Doe"  type="text" label="Last Name"/>
                <x-form.input_register name="password" placeholder="yourpassword" type="password" label="Password"/>
                <x-form.input_register name="password_confirmation" placeholder="yourpassword" type="password" label="Repeat Password"/>
